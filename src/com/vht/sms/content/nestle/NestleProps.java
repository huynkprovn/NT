...
/**
 * The Class NestleProps.
 */
public class NestleProps extends PropertiesConfiguration
{
	
	/** The log. */
	private static Log log = LogFactory.getLog(NestleProps.class);

	/**
	 * paths to search for API properties file. There always end in the "/"
	 * character and end entity is empty string
	 */
	private static final String[] SEARCH_PATH = {"/com/vht/sms/content/nestle/"};

	/** Name of properties file to get resource. */
	private static final String PROPS_RESOURCE = "nestle.properties";

	/**
	 * The singleton instance of the engine configuration.
	 */
	private static NestleProps instance = null;
	 ...
	 */
	public static final NestleProps getInstance() {
		if (instance == null) {
			instance = new NestleProps();
