...
public class TtagasProps extends PropertiesConfiguration
{
	private static Log log = LogFactory.getLog(TtagasProps.class);

	/**
	 * paths to search for API properties file. There always end in the "/"
	 * character and end entity is empty string
	 */
	private static final String[] SEARCH_PATH = {"/com/vht/sms/content/tta/"};

	/**
	 * Name of properties file to get resource
	 */
	private static final String PROPS_RESOURCE = "tta.properties";

	/**
	 * The singleton instance of the engine configuration.
	 */
	private static TtagasProps instance = null;
	 ...
	 */
	public static final TtagasProps getInstance() {
		if (instance == null) {
			instance = new TtagasProps();
