...
public class DmvtProps extends PropertiesConfiguration
{
	private static Log log = LogFactory.getLog(DmvtProps.class);

	/**
	 * paths to search for API properties file. There always end in the "/"
	 * character and end entity is empty string
	 */
	private static final String[] SEARCH_PATH = {"/com/vht/sms/content/dmvt/"};

	/**
	 * Name of properties file to get resource
	 */
	private static final String PROPS_RESOURCE = "dmvt.properties";

	/**
	 * The singleton instance of the engine configuration.
	 */
	private static DmvtProps instance = null;
	 ...
	 */
	public static final DmvtProps getInstance() {
		if (instance == null) {
			instance = new DmvtProps();
