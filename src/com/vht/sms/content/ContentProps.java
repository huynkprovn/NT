...
public class ContentProps extends PropertiesConfiguration
{
	private static Log log = LogFactory.getLog(ContentProps.class);

	/**
	 * paths to search for API properties file. There always end in the "/"
	 * character and end entity is empty string
	 */
	private static final String[] SEARCH_PATH = {"/com/vht/sms/content/"};

	/**
	 * Name of properties file to get resource
	 */
	private static final String PROPS_RESOURCE = "content-factory.properties";

	/**
	 * The singleton instance of the engine configuration.
	 */
	private static ContentProps instance = null;
	 ...
	 */
	public static final ContentProps getInstance() {
		if (instance == null) {
			instance = new ContentProps();
