 ...
 */
public class MowProps extends PropertiesConfiguration
{
	
	/** The log. */
	private static Log log = LogFactory.getLog(MowProps.class);

	/**
	 * paths to search for API properties file. There always end in the "/"
	 * character and end entity is empty string
	 */
	private static final String[] SEARCH_PATH = {"/com/vht/sms/content/mow/"};

	/** Name of properties file to get resource. */
	private static final String PROPS_RESOURCE = "mow.properties";

	/**
	 * The singleton instance of the engine configuration.
	 */
	private static MowProps instance = null;
	 ...
	 */
	public static final MowProps getInstance() {
		if (instance == null) {
			instance = new MowProps();
